...
function GetSFT() {
    return Document.getElementById("sft");
}
...
function GetWalletSFTs()
{
    return wallet.SFTs;
}


function EstablishRedirect()
{
...
describe('ConnectWalletTest', function() {
    it('should return wallet not null', function() {
      assert.equal(ConnectWallet());
    });
    it('should return the wallet balance', function() {
        assert.equal(GetWalletBalance());
      });
      it('should return wallet sfts', function() {
        assert.equal(GetWalletSFTs());
      });
});
...
describe('WebsiteButtons', function() {
    ...
    it('should redirect to About SFT section', function() {
      assert.equal(EstablishRedirect());
    });
});
...
describe('Search', function() {
    it('should return an array of length greater than zero', function() {
      assert.equal(ConnectBlockchain());
    });
});
